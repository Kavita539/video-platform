...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden bg-base">
      ...
      <div className="bg-surface border border-border-bright rounded-[var(--radius-lg)] p-10 w-full max-w-[420px] relative z-10 shadow-[0_32px_80px_rgba(0,0,0,0.5)] animate-[fadeUp_0.35s_ease_forwards]">
        {/* Brand */}
        ...
        {/* Tagline */}
        <p className="text-[0.78rem] text-muted mb-[28px] tracking-[0.02em]">
          {mode === "login"
        ...
        <p className="mt-5 text-center text-[0.78rem] text-muted">
          ...
          <button
            type="button"
            className="bg-transparent border-none text-accent font-[var(--font-mono)] text-[0.78rem] cursor-pointer hover:underline hover:text-accent transition-all"
            onClick={() => {
